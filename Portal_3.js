...
(function (global) {
    ...
    function buildStandaloneGeometry() {
        ...
        try {
            createTowerRoom("left");
            createTowerRoom("right");
            createTower();
    ...
    function initializeStandalonePortal3() {
        if (hasInitialized) {
            return;
        }
    ...
    global.PortalStandalone.tower = initializeStandalonePortal3;
    global.PortalStandalone["3"] = initializeStandalonePortal3;
